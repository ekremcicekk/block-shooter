...
namespace BlockShooter.Editor
{
    ...
    public class GameConfigEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            // Draw list
            if (config.colors == null) config.colors = new List<GameConfig.ColorDefinition>();
            ...
            if (GUILayout.Button("Add New Custom Color", GUILayout.Height(24)))
            {
                ...
                else
                {
                    ...
                    config.colors.Add(new GameConfig.ColorDefinition
                    {
                        colorType = nextSlot,
        ...
        private BlockColorType FindNextUnusedCustomSlot(GameConfig config)
        {
